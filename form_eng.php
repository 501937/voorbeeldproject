...
<body>
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <p>Fill in this form to add items to the database.</p>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
    ...
    if ($conn->connect_error) {
        die("Connection failed errorcode: " . $conn->connection_error);
    }
    echo("Connection to the database has been established!");

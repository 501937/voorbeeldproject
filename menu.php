        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                    <a href="form.php"><img border="0" alt="Add Item" src="img/add.png" width="20" height="20"></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Kantine
                        <strong>Menu</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    ...
                    <p>Onderaan vindt u het Leeuwlicious Menu</p>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
...
<?php
    ...
    include_once("connection.inc.php"); //conntectie DB
    include_once("select.inc.php"); //toon gegevens uit DB
    ?>            
                </div>
            </div>
        </div>
